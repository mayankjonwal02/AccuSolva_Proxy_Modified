...
const NewZealand = () => {
  return (
    <>
      <Hero
        heading={"New Zealand Proxy 2403 IPs"}
        desc={
          "Are you tired of getting blocked from websites in New Zealand? Our network spans across different regions of New Zealand and can be used for web scraping, SEO, and marketing. With our fast and stable residential proxies, you can access local data and websites as if you were physically located in New Zealand."
        }
        desc2={
          "Stop getting blocked from websites and start scraping data from New Zealand with our reliable residential proxies. Our advanced proxy rotation system and large pool of available IP addresses ensure a high success rate for your operations. Our proxies are private and secure, ensuring that your online activity is kept confidential."
        }
        btn={"Contact Sales"}
        py={"py-[80px]"}
        bgImg={bgImg}
      ...
      <Usecase
        bg={"bg-[#F8FBFB]"}
        title2={"New Zealand AccuSolva proxy"}
