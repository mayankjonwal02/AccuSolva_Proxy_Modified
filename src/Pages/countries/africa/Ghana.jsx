...
const Ghana = () => {
  return (
    <>
      <Hero
        heading={"Ghana Proxy 4141 IPs"}
        desc={
          "Are you tired of getting blocked from websites in Ghana? Our network spans across different regions of Ghana and can be used for web scraping, SEO, and marketing. With our fast and stable residential proxies, you can access local data and websites as if you were physically located in Ghana."
        }
        desc2={
          "Stop getting blocked from websites and start scraping data from Ghana with our reliable residential proxies. Our advanced proxy rotation system and large pool of available IP addresses ensure a high success rate for your operations. Our proxies are private and secure, ensuring that your online activity is kept confidential."
        }
        btn={"Contact Sales"}
        py={"py-[80px]"}
        bgImg={bgImg}
