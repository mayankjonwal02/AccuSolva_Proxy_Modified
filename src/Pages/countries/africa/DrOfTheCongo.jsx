...
const DrOfTheCongo = () => {
  return (
    <>
      <Hero
        heading={"D.R Of The Congo Proxy 345 IPs"}
        desc={
          "Are you tired of getting blocked from websites in D.R Of The Congo? Our network spans across different regions of D.R Of The Congo and can be used for web scraping, SEO, and marketing. With our fast and stable residential proxies, you can access local data and websites as if you were physically located in D.R Of The Congo."
        }
        desc2={
          "Stop getting blocked from websites and start scraping data from D.R Of The Congo with our reliable residential proxies. Our advanced proxy rotation system and large pool of available IP addresses ensure a high success rate for your operations. Our proxies are private and secure, ensuring that your online activity is kept confidential."
        }
        btn={"Contact Sales"}
        py={"py-[80px]"}
        bgImg={bgImg}
      ...
      <Usecase
        bg={"bg-[#F8FBFB]"}
        title2={"D.R Of The Congo AccuSolva proxy"}
